...
class SensorMLP(nn.Module):
    ...
    def __init__(self):
        ...
        self.fcl1 = nn.Linear(20, 64) # 20 features -> 64 hidden units
        ...
        self.fcl2 = nn.Linear(64, 32) # 64 units -> 32 hidden units
        
        # TODO: Define output Layer 3 (32 -> 4 classes)
        self.fcl3 = nn.Linear(32, 4) # 32 units -> 4 output classes
...
def train_and_validate():
    ...
    for epoch in range(epochs):
        ...
        train_loss = criterion(predictions, y_train) # Replace with actual loss
        ...
        if val_loss < best_val_loss:
            ...
            print(f"New best model found at Epoch {epoch+1:02d}! Saving model...")
